...
def check_file(sInput, iResample, bSave, sCutDir):
    ...
    if bSave:
        ...
        for sCut in lsCuts:
            ...
            #print dSortedTypes['lsNames'], "\t",  dSortedTypes['liConfidence']
    ...
    print "---aggregated:  ", lAggregatedNames, lAggregatedValues
...
sound = AudioSegment.from_mp3(sMp3)
sound.export(sInput, format="wav")

#import isolate
#isolate.isolate_cries(sInput, bSave=True, sCutDir=sCutDir)
